...
const Hero = () => {
  ...
  return (
    <main id="home" className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        ...
        <header className="special-font hero-heading absolute bottom-5 right-5 z-40 text-blue-75">
          G<b>a</b>ming
        </header>
